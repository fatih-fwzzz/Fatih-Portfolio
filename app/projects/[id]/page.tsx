...
const PROJECT_DETAILS: Record<string, ExtendedProjectData> = {
  ...
  "kenali-diri": {
    ...
    description:
      "A gamified educational platform designed to break the stigma of sexual health education for Indonesian youth, proven to increase student knowledge.",
    ...
    challenge:
      "The true engineering feat wasn't just the gamification, but architecting a bulletproof backend capable of handling sensitive data and high-concurrency classroom bursts. We engineered a secure environment using SHA256 and JWT for robust authentication, while optimizing our REST API to ensure zero-latency responses under heavy load. To drive real-time competition, we implemented WebSockets for live leaderboards, successfully stress-tested in Jakarta high schools with flawless performance.",
    challengeBullets: [
      "Securing user identities with SHA256 & JWT authentication",
      "Optimizing REST API throughput for high-concurrency loads",
      "Engineering real-time leaderboards via WebSockets",
    ],
    features: [
      {
        icon: "fa-map",
        ...
        desc: "Level-based learning journey to track progress.",
      },
      {
        icon: "fa-certificate",
        colorBg: "bg-yellow-100",
        ...
        desc: "Visual feedback and achievements for motivation.",
      },
      {
        icon: "fa-bolt",
        colorBg: "bg-purple-100",
        colorText: "text-purple-600",
        title: "WebSocket",
        desc: "Real-time updatews for live leaderboards.",
      },
      {
        ...
        colorText: "text-green-600",
        title: "Pre & Post Test",
        desc: "Measurable knowledge assessment system.",
      },
      {
        icon: "fa-lock",
        colorBg: "bg-red-100",
        ...
        desc: "Advanced encryption for user data protection.",
      },
      {
        icon: "fa-mobile-screen",
        colorBg: "bg-indigo-100",
        colorText: "text-indigo-600",
        title: "Universal UI",
        desc: "Responsive design for Phone, Tablet, & PC.",
      },
    ],
    process: [
      {
        step: 1,
        title: "Secure Schema & API",
        description:
          "Designed a secure data structure using SHA256 hashing to protect student identities, and built a high-performance API capable of serving class-wide traffic without any lag.",
      },
      {
        step: 2,
        title: "Gamified Logic Engine",
        description:
          "Engineered a dynamic progression system that tracks user states, unlocks levels, and triggers real-time WebSocket events for immediate feedback.",
      },
      {
        step: 3,
        title: "Evaluation & Results",
        description:
          "Deployed to students for testing. The platform achieved a 'Grade B' usability score (SUS 74.3) and successfully improved test scores from 73 to 81.9.",
        stats: [
          { value: "+8.9", label: "Score Increase" },
          { value: "74.3", label: "SUS Score" },
        ],
      },
    ],
    techStack: [
      ...
      {
        name: "MSSQL",
        logo: "https://img.icons8.com/color/1200/microsoft-sql-server.jpg",
        category: "Database",
      },
    ],
    impact: {
      stats: [
        { value: "81.9", label: "Post-Test Avg", color: "text-green-600" },
        { value: "74.3", label: "Usability Score", color: "text-blue-600" },
        { value: "100%", label: "Blackbox Pass", color: "text-purple-600" },
      ],
      quote: {
        text: "The gamified approach made learning about sexual health less awkward and actually fun. I felt like I was playing a game but learned a lot alongside my classmates.",
        author: "Student",
        role: "SMKN 10 Jakarta",
      },
    },
    gallery: [
  ...
  pahamikulit: {
    ...
    challenge:
      "Our comprehensive goal was to educate users about local skincare products while ensuring precise personalization. We implemented the Simple Additive Weighting (SAW) algorithm to mathematically rank product suitability based on individual skin problems. Simultaneously, we secured user accounts with SHA256 encryption and crafted a strictly user-friendly uni-sex interface to make skincare education approachable for everyone.",
    challengeBullets: [
      "Precision recommendations via SAW Algorithm",
      "Account security using SHA256 hashing",
      "Designing an inclusive, gender-neutral UI",
    ],
    features: [
      {
        icon: "fa-droplet",
      ...
      },
      {
        ...
        colorText: "text-purple-600",
        title: "Mix & Match",
        desc: "Simulate ingredient combos.",
      },
      {
        icon: "fa-list-check",
        colorBg: "bg-green-100",
      ...
      },
      {
        ...
        desc: "Adaptive gender-based interface.",
      },
      {
        ...
        colorText: "text-gray-600",
        title: "User Tested",
        desc: "Validated by 28 respondents.",
      },
    ],
    process: [
      {
        step: 1,
        title: "Data Collection & SAW",
        description:
          "Engineered a Python scraper to index 20+ products and implemented the SAW algorithm to mathematically rank recommendation suitability.",
      },
      {
        step: 2,
        title: "Interactive Development",
        description:
          "Built the Skin Type Test and Mix & Match features, focusing on error prevention and efficiency (Human Factors).",
      },
      {
        step: 3,
        title: "Rigorous Evaluation",
        description:
          "Conducted testing with 28 students. Knowledge increased by 13.22 points, and the app achieved a System Usability Scale (SUS) score of 83.2 (Grade A).",
        stats: [
          { value: "+13.2", label: "Knowledge Gain" },
          { value: "83.2", label: "SUS Score" },
        ],
      },
    ],
    techStack: [
    ...
    impact: {
      stats: [
        { value: "89.29", label: "Post-Test Avg", color: "text-green-600" },
        { value: "83.2", label: "Grade A (SUS)", color: "text-blue-600" },
        { value: "100%", label: "Test Pass Rate", color: "text-purple-600" },
      ],
      quote: {
        text: "The application is incredibly helpful. I finally understand which ingredients I shouldn't mix, and the product recommendations actually work for my skin type.",
        author: "Student",
        role: "SMP Dharma Karya UT",
      },
    },
    gallery: [
